...
# instance fields
.field public final backendFactoryProvider:Lcom/google/zxing/Result;

.field public final backends:Ljava/util/HashMap;

.field public final creationContextFactory:Landroidx/emoji2/text/EmojiProcessor;


# direct methods
.method public constructor <init>(Landroid/content/Context;Landroidx/emoji2/text/EmojiProcessor;)V
    .locals 2
    ...
    .line 4
    invoke-direct {v0, p1, v1}, Lcom/google/zxing/Result;-><init>(Landroid/content/Context;I)V
    ...
    .line 16
    .line 17
    iput-object v0, p0, Lcom/google/android/datatransport/runtime/backends/MetadataBackendRegistry;->backendFactoryProvider:Lcom/google/zxing/Result;

    .line 18
    .line 19
    iput-object p2, p0, Lcom/google/android/datatransport/runtime/backends/MetadataBackendRegistry;->creationContextFactory:Landroidx/emoji2/text/EmojiProcessor;
...
.method public final declared-synchronized get(Ljava/lang/String;)Lcom/google/android/datatransport/runtime/backends/TransportBackend;
    ...
    :cond_0
    :try_start_1
    iget-object v0, p0, Lcom/google/android/datatransport/runtime/backends/MetadataBackendRegistry;->backendFactoryProvider:Lcom/google/zxing/Result;

    .line 23
    .line 24
    invoke-virtual {v0, p1}, Lcom/google/zxing/Result;->get(Ljava/lang/String;)Lcom/google/android/datatransport/cct/CctBackendFactory;
    ...
    :cond_1
    :try_start_2
    iget-object v1, p0, Lcom/google/android/datatransport/runtime/backends/MetadataBackendRegistry;->creationContextFactory:Landroidx/emoji2/text/EmojiProcessor;

    .line 34
    .line 35
    iget-object v2, v1, Landroidx/emoji2/text/EmojiProcessor;->mSpanFactory:Ljava/lang/Object;
