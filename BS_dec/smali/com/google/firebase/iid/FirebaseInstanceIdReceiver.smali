...
.method public final onMessageReceive(Landroid/content/Context;Lcom/google/android/gms/cloudmessaging/CloudMessage;)I
    ...
    .line 2
    .line 3
    invoke-direct {v0, p1}, Lcom/google/firebase/messaging/RequestDeduplicator;-><init>(Landroid/content/Context;)V

    .line 4
    .line 5
    .line 6
    iget-object p1, p2, Lcom/google/android/gms/cloudmessaging/CloudMessage;->zza:Landroid/content/Intent;

    .line 7
    .line 8
    invoke-virtual {v0, p1}, Lcom/google/firebase/messaging/RequestDeduplicator;->process(Landroid/content/Intent;)Lcom/google/android/gms/tasks/Task;
...
.method public final onNotificationDismissed(Landroid/os/Bundle;)V
    .locals 2
    ...
    .line 24
    invoke-static {p1, v0}, Lio/sentry/util/LogUtils;->logToScion(Landroid/os/Bundle;Ljava/lang/String;)V
